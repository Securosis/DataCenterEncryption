...
The encryption engine and the key store are the major functional pieces in any encryption platform, but there are supporting systems in any data center encryption solution which are important both for overall management and to tailor the solution to fit your application infrastructure. We frequently see the following major features and options to support customer needs:
...
For details see our paper on [Defending Cloud Data with Infrastructure Encryption](https://securosis.com/Research/Publication/defending-cloud-data-with-infrastructure-encryption).
