...
The encryption engine and the key store are the key functional components of any encryption system, but any data center encryption solution includes supporting systems which are important -- for both overall management and tailoring the solution to fit your application infrastructure. Consider the major supporting components and variations.
